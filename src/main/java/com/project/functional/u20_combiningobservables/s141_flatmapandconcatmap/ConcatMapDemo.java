...
public class ConcatMapDemo {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // Wait for a moment to ensure all synchronous operations complete
        Thread.sleep(30000); // This is just to keep the JVM alive to see the results
    }
